	...
	$.fn.lubo=function(options){
		...
		//生成左右按钮
			...
			function Btn(){
				...
				_btn.append('<div class="leftBtn"></div><div class="rightBtn"></div>');
...
$(function(){
	...
	$(".lubo_btn .leftBtn").hover(function(){
		$(this).addClass("leftBtnOn")
	},function(){
		$(this).removeClass("leftBtnOn");
	});
	$(".lubo_btn .rightBtn").hover(function(){
		$(this).addClass("rightBtnOn")
	},function(){
		$(this).removeClass("rightBtnOn");
	});
 });
