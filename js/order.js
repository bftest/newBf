...
//浏览器滚动距离
   function scollHeight(){
    ...
    //comment
   $(".op .opBtn").click(function(){
       $(this).hasClass("cur") ? $(this).removeClass("cur").parent().parent().next().hide(): $(this).addClass("cur").parent().parent().next().show();
   });
    $(".comList:last").css({"border-bottom":"1px solid #ccc"});
    $(".scoreAssessList .dd").each(function(){
